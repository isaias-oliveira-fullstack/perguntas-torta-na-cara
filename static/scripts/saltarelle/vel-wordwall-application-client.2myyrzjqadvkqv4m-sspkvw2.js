(function () {
  ...
  var n = function () {
    ...
    this.$q = new p(this);
    this.$z = new q();
    this.$v = new VEL.Wordwall.Global.Controls.Control.$ctor1(
      ".js-play-preload"
    );
    this.$A = VEL.Wordwall.Global.Helpers.SettingsHelper.get$2(
      "session_id",
      null
    );
    ...
    if (!(ServerModel.templateId === undefined)) {
      var a = VEL.Wordwall.Core.Application.TemplateManager.getTemplate(
  ...
  ss.initClass(
    ...
    k,
    {
      ...
      setThemeId: function (a, b) {
        ...
        this.$C.selected =
          VEL.Wordwall.Core.View.Themes.ThemeHelper.getTheme(a);
        if (b) {
          this.destroyView();
          this.$k();
        }
      ...
      startTestGame: function (a, b, c) {
        ...
        this.$q.openTest(
          ...
          ss.mkdel(this, function (d) {
            this.$f(d, ServerModel.testConvertToTemplateId);
          })
        );
      },
      onStartComplete: function () {
        ...
        var c =
          "/resourceajax/trackplay?activityId=" +
      ...
      onSetAudioSetting: function (a, b) {
        var c = ss.Enum.getName(
          VEL.Wordwall.Global.Enums.AudioSetting,
          a
        ).toLowerCase();
        this.setSetting(c, b.toString(), false);
      },
      onGetAudioSetting: function (a) {
        var b = ss.Enum.getName(
          VEL.Wordwall.Global.Enums.AudioSetting,
          a
        ).toLowerCase();
        ...
        if (c === "") {
          ...
          if (c === "") {
            ...
            if (a === 0) {
              switch (
                VEL.Wordwall.Global.Server.Switches.getInteger(
                  VEL.Wordwall.Global.Server.Switches.static$1,
                  VEL.Wordwall.Global.Server.SwitchKeys.musicDefaultMuteSetting
                )
              ) {
                case 1:
                  e = false;
                ...
                case 2:
                  e =
                    this.get_document().get_template().get_themeRequirements()
                      .musicType !== 1;
                  break;
                case 0:
                default:
      ...
      $9: function (a, b, c) {
        ...
        this.set_activeGame(
          new VEL.Wordwall.Core.Games.PreStartGame(g, this, h)
        );
        g.onPreStart(
          ServerModel.activityTitle,
          f.get_title(),
          f.get_description(),
          i
        );
      ...
      $f: function (a, b) {
        ...
        if (
          ss.isValue(b) &&
          b !== 0 &&
          b !== this.get_document().get_template().get_id()
        ) {
      ...
      $k: function () {
        ...
        var c =
          this.get_document()
            ...
            .get_contentModel()
            .getUnicodeRange() |
          VEL.Wordwall.Core.DataStructures.UnicodeRange.getUnicodeRange(
            ServerModel.languageId
          );
        var d = VEL.Wordwall.Global.Server.Switches.getThemeAudio(
          VEL.Wordwall.Global.Server.Switches.static$1,
          this.$C.selected.id
        );
        VEL.Wordwall.View.Assets.AssetLoader.start(
          ...
          b,
          true,
          ss.mkdel(this, this.$g),
          ss.mkdel(this, this.$e),
          this.onGetAudioSetting(0),
          d
        );
        this.$y = window.setTimeout(
          ss.mkdel(this, function () {
            this.$d();
            if (this.$u) {
              return;
      ...
      $c: function (e, f) {
        ...
        if (this.$B === 5 && f !== 0) {
          this.$C.selected =
            VEL.Wordwall.Core.View.Themes.ThemeHelper.getTheme(f);
          this.$C.available = [this.$C.selected];
          return;
        }
        var g = Enumerable.from(
          VEL.Wordwall.Core.View.Themes.ThemeHelper.getAvailableThemeIds(e)
        )
        ...
        for (var i = 0; i < h.length; i++) {
          var j = h[i];
          var E = VEL.Wordwall.Global.Server.Switches.getThemeAction(
            VEL.Wordwall.Global.Server.Switches.static$1,
            j.id,
            e
          );
          if (E === 0) {
            E = VEL.Wordwall.Global.Server.Switches.getThemeAction(
              VEL.Wordwall.Global.Server.Switches.static$1,
              j.id,
              0
            );
        ...
        if (
          Enumerable.from(g).all(function (u) {
            return u.isHidden;
          })
        ) {
          var J =
            Enumerable.from(g).firstOrDefault(function (u) {
              return u.id === f;
            }, ss.getDefaultValue(VEL.Wordwall.Core.View.Themes.Theme)) ||
            Enumerable.from(g).first();
          J.isHidden = false;
        }
        var K = Enumerable.from(g)
          .where(function (u) {
            return u.isHidden;
          })
          .toArray();
        ...
        for (var a = 0; a < N.length; a++) {
          var b = N[a];
          var c = VEL.Wordwall.Global.Server.Switches.getThemeAction(
            VEL.Wordwall.Global.Server.Switches.static$1,
            b.id,
            e
          );
          if (c === 0) {
            c = VEL.Wordwall.Global.Server.Switches.getThemeAction(
              VEL.Wordwall.Global.Server.Switches.static$1,
              b.id,
              0
            );
        ...
        var d =
          f !== 0
            ? Enumerable.from(g).singleOrDefault(function (u) {
                return u.id === f;
              }, ss.getDefaultValue(VEL.Wordwall.Core.View.Themes.Theme))
            : null;
        if (ss.isValue(d)) {
      ...
      $b: function (a, b) {
        return Enumerable.from(b).firstOrDefault(function (c) {
          return (
            (a.baseId === c.id || c.baseId === c.id) &&
            !ss.referenceEquals(a, c) &&
            !c.isHidden
          );
        }, ss.getDefaultValue(VEL.Wordwall.Core.View.Themes.Theme));
      },
  ...
  ss.initClass(p, k, {
    open: function (a, b, c, d, e, f) {
      ...
      if (
        !g &&
        (ServerModel.userId === undefined ||
          ServerModel.activityId === undefined)
      ) {
        b = false;
      }
    ...
    openTest: function (a, b, c, d) {
      ...
      this.open(
        ...
        true,
        e,
        ServerModel.testConvertToTemplateId,
        c,
        d
      );
    },
    ...
    save: function (a, b, c, d, e, f, g, h, i) {
      this.$c = true;
      if (!ss.isNullOrEmptyString(i)) {
        this.$9.get_document().set_title(i);
      }
      if (c > 0) {
    ...
    $1: function (a, b) {
      ...
      var f = "http://127.0.0.1:5500/documents/" + a;
      var g = "http://127.0.0.1:5500/documents/" + a;
      this.$2(
        f,
        function (h) {
          h.set_guid(a);
    ...
    $8: function (a, b, c, d, e, f) {
      var g = this.$9.get_document().get_guid();
      var h = this.$9.get_document().save();
      var i =
        ...
        a +
        "&userId=" +
        this.$9.get_document().get_userId() +
        "&aiAssists=" +
        e;
      if (ss.isValue(f)) {
        i += "&genAIMethod=" + ss.unbox(f);
      }
      if (ss.isValue(b)) {
        i += "&folderId=" + b;
      }
      ...
      i +=
        "&originalActivityId=" +
        (ServerModel.originalActivityId === undefined
          ? 0
          : ServerModel.originalActivityId);
      var j = new Uint8Array(h.byteLength);
      for (var w = 0; w < h.byteLength; w++) {
        j[w] = h.getUint8(w);
      }
      var x = new XMLHttpRequest();
      x.open("POST", i, true);
      x.onreadystatechange = function (u) {
        if (x.readyState === 4) {
          if (x.status === 200) {
            var v = JSON.parse(x.responseText);
            VEL.Wordwall.Global.Helpers.AutoSaveHelper.clear();
            c(v.ActivityId, v.ActivityGuid);
          } else {
    ...
    $4: function (a, b) {
      ...
      window.localStorage["autosave.templateid"] = a
        .get_template()
        .get_id()
        .toString();
  ...
  ss.initClass(q, k, {
    ...
    onHomeworkSubmission: function (a, b, c) {
      ...
      var e = {
        type: "POST",
        url:
          "/MyResultsAjax/AddHomeworkSubmission?homeworkGameId=" +
          ServerModel.homeworkGameId +
          "&name=" +
          encodeURIComponent(a.get_player().get_fullName()) +
          "&score=" +
          a.get_score() +
          "&time=" +
          a.get_timing() +
        ...
        success: function (f, g, h) {
          $.get(
            "/MyResultsAjax/RefreshHomework?homeworkGameId=" +
              ServerModel.homeworkGameId
          );
  ...
  ss.initClass(r, k, {
    ...
    $3: function (a) {
      var b =
        VEL.Wordwall.Global.Helpers.GoogleClassroomHelper.exceptionToError(a);
                ...
                try {
                  $sm2: for (;;) {
                    switch (b) {
                      case 1:
                        b = -1;
                        d = a.getMyCourseWorkStudentSubmission(
                          this.$d,
                          this.$e
                        );
                        b = 2;
                  ...
                  $sm2: for (;;) {
                    switch (b) {
                      ...
                      case 2:
                        ...
                        c.setResult(
                          Enumerable.from(e).firstOrDefault(
          ...
          $sm1: for (;;) {
            switch (b) {
              case 0:
                b = -1;
                if (
                  a.get_userCanTurnInSubmission() &&
                  !a.get_userHasTurnedInSubmission()
                ) {
                  d = this.$2();
                  b = 1;
                  d.continueWith(g);
              ...
              case 1:
                b = -1;
                e = d.getAwaitedResult();
                f = e.turnInStudentSubmission(
                  a.get_studentSubmission().courseId,
                  a.get_studentSubmission().courseWorkId,
                  a.get_studentSubmission().id
                );
                b = 2;
                f.continueWith(g);
                return;
                ...
                case 3:
                  ...
                  try {
                    ...
                    if (ss.isInstanceOfType(h, ss.PromiseException)) {
                      ...
                      s.$1.reportGoogleClassroomError(
  ...
  (function () {
    s.$1 = new VEL.Wordwall.Global.Helpers.GoogleClassroomErrorReporter(
